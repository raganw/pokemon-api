...
async fn main() -> Result<()> {
    ...
    let database_url = env::var("DATABASE_URL")
        .wrap_err("Must have a DATABASE_URL environment variable")
    ...
    let pool = MySqlPoolOptions::new()
        ...
        .await
        .suggestion("The form of a mysql connection URL is `mysql://username:password@host:port/database`")?;
    ...
    {
        let name = pokemon.evolves_from.expect("Expected a value here since we just checked");
